...
export namespace Prisma {
  ...
  */
    ...
    model: {
      ...
      SquareData: {
        ...
        operations: {
          ...
          createMany: {
            args: Prisma.SquareDataCreateManyArgs<ExtArgs>,
            result: Prisma.BatchPayload
          }
          delete: {
  ...
  export type AggregateSquareData = {
    ...
    _avg: SquareDataAvgAggregateOutputType | null
    _sum: SquareDataSumAggregateOutputType | null
    _min: SquareDataMinAggregateOutputType | null
    _max: SquareDataMaxAggregateOutputType | null
  }

  export type SquareDataAvgAggregateOutputType = {
    id: number | null
  }

  export type SquareDataSumAggregateOutputType = {
    id: number | null
  }
  ...
  export type SquareDataAvgAggregateInputType = {
    id?: true
  }

  export type SquareDataSumAggregateInputType = {
    id?: true
  }
  ...
  export type SquareDataAggregateArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    ...
    **/
    _avg?: SquareDataAvgAggregateInputType
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/aggregations Aggregation Docs}
     * 
     * Select which fields to sum
    **/
    _sum?: SquareDataSumAggregateInputType
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/aggregations Aggregation Docs}
     * 
     * Select which fields to find the minimum value
  ...
  export interface SquareDataDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> {
    ...
    **/
    ...
    /**
     * Create many SquareData.
     *     @param {SquareDataCreateManyArgs} args - Arguments to create many SquareData.
     *     @example
     *     // Create many SquareData
     *     const squareData = await prisma.squareData.createMany({
     *       data: {
     *         // ... provide data here
     *       }
     *     })
     *     
    **/
    createMany<T extends SquareDataCreateManyArgs<ExtArgs>>(
      args?: SelectSubset<T, SquareDataCreateManyArgs<ExtArgs>>
    ): Prisma.PrismaPromise<BatchPayload>
  ...
  interface SquareDataFieldRefs {
    readonly id: FieldRef<"SquareData", 'Int'>
  ...
  /**
   * SquareData createMany
   */
  export type SquareDataCreateManyArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * The data used to create many SquareData.
     */
    data: SquareDataCreateManyInput | SquareDataCreateManyInput[]
    skipDuplicates?: boolean
  }
  ...
  export type SquareDataWhereInput = {
    ...
    id?: IntFilter<"SquareData"> | number
  ...
  export type SquareDataOrderByWithAggregationInput = {
    ...
    _avg?: SquareDataAvgOrderByAggregateInput
    _max?: SquareDataMaxOrderByAggregateInput
    _min?: SquareDataMinOrderByAggregateInput
    _sum?: SquareDataSumOrderByAggregateInput
  }
  ...
  export type SquareDataScalarWhereWithAggregatesInput = {
    ...
    id?: IntWithAggregatesFilter<"SquareData"> | number
  ...
  export type SquareDataCreateManyInput = {
    id?: number
    tokens: string
    expiresAt: string
    merchantId: string
  ...
  export type SquareDataAvgOrderByAggregateInput = {
    id?: SortOrder
  }
  ...
  export type SquareDataSumOrderByAggregateInput = {
    id?: SortOrder
  }
